...
tab <- matrix(c(rf_reg_res, rf_reg_res, gbm_reg_res, gbm_reg_tuned_res, svm_reg_res, 
                svm_reg_tuned_res), nrow = 6, ncol = 2, byrow = TRUE)
...
rf_cl_tuned_fit <- ranger(Popularity_quantized ~ ., data = cl_train, 
...
tab <- matrix(c(rf_table$overall[1], rf_table$overall[1], gbm_table$overall[1], 
                gbm_tuned_table$overall[1], svm_table$overall[1], svm_table$overall[1]), 
